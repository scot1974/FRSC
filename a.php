  ...
  <nav class="top-nav">
    <div class="shell"> <a href="#" class="nav-btn">HOMEPAGE<span></span></a> <span class="top-nav-shadow"></span>
      <ul>
        ...
        <li><span><a href="admin/Login.php">Admin Login</a></span></li>
      ...
      <div class="header-inner">
        ...
        <div class="slider-holder">
          <div class="flexslider">
            <ul class="slides">
              <li><img src="images/frsc1.jpg" alt=""></li>
              <li><img src="images/traffic3.jpg" alt=""></li>
              <li><img src="images/slide4.jpg" alt=""></li>
              <li><img src="images/traffic4.jpg" alt=""></li>
    ...
    <div class="shell">
      <div class="container">
        ...
        <section class="testimonial">
          <h2>Federal Road Safety Commission Traffic Offender Tracking System</h2>
          <p><strong>“</strong>Federal Road Safety Commission Traffic Offender Tracking System is a powerful web application and data base program that records and track all the traffic offender committed nationwide. <strong>"</strong></p>
        </section>
        ...
        <section class="blog">
          ...
          <div class="content"> 
            <div class="cnt">
              <h3>FRSC Road Traffic Offences and Fines Every Body Should Know</h3>
              <p>
              <li class="fine"><strong>ACS – ATTEMPTING TO CORRUPT MARSHAL ON DUTY  10,000.00</strong></li>
              <li class="fine"><strong>AMD – ASSAULTING MARSHAL ON DUTY 10,000.00</strong></li>
              <li class="fine"><strong>CAV – CONSTRUCTION AREA SPEED LIMIT VIOLATION  3,000.00</strong></li>
              <li class="fine"><strong> DUI – DRIVING UNDER ALCOHOL/DRUG INFLUENCE 5,000.00</strong></li>
              <li class="fine"><strong>LSV – LIGHT/SIGN VIOLATION 2,000.00</strong></li>
              <li class="fine"><strong>NPV – NUMBER PLATE VIOLATION 10,000.00</strong></li>
              <li class="fine"><strong>OFD – OPERATING A VEHICLE WITH FORGED DOCUMENTS  20,000.00</strong></li>
              <li class="fine"><strong>RMV – ROAD MARKING VIOLATION 5,000.00</strong></li>
              <li class="fine"><strong>SLV – SPEED LIMIT VIOLATION  3,000.00</strong></li>
              <li class="fine"><strong>UPD – USE OF PHONE WHILE DRIVING 4,000.00</strong></li>
              ...
              <ul>
                <li>
                 <div class="img-holder"> <a href="#"><img src="images/hms2.jpg" alt=""></a> </div>
                  <p><a href="#">Presidency promotes 907 FRSC officers | New Mail Nigeria </p>
                </li>
                <li>
                    <div class="img-holder"> <a href="#"><img src="images/hms3.jpg" alt=""></a> </div>
                  <p><a href="#">FRSC van crashes while chasing alleged traffic offender in Oyo Ibadan...  </p>
                </li>
                <li>
                  <div class="img-holder"> <a href="#"><img src="images/hms4.jpg" alt=""></a> </div>
                  <p> <a href="#">Nigeria Lost N7 Billion To Tanker Accidents In 25 Weeks ....</p>
                </li>
              </ul>
              <div class="cl">&nbsp;</div>
            </div>
...
<nav class="navbar navbar-light" style="background-color: #e3f2fd;">
  <!-- Navbar content -->
    ...
    https://github.com/scot1974/FRSC-Traffic-Tracking-system